...
//    var url = "https://pokeapi.co/api/v2/pokemon?offset=\(start)&limit=30"

//    static func next(completion: @escaping(PokemonPage) -> Void {
//        fetchData(url: "https://pokeapi.co/api/v2/pokemon?offset=\(start)&limit=30", model: PokemonPage.self) { page in
//            completion(page))
//        } failure: { error in
